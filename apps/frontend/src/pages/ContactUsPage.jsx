    ...
    <>
      ...
      <div className="min-h-screen w-full flex flex-col items-center justify-center bg-[#FEF7ED]" style={{ marginTop: '0px' }}>
        <div className="max-w-2xl w-full mx-auto p-8 bg-white rounded-2xl shadow-2xl flex flex-col items-center animate-fade-in-up" style={{ marginTop: '32px', marginBottom: '32px' }}>
          <h1 className="text-4xl font-bold mb-2 text-red-600 text-center">Contact Us</h1>
          <p className="text-gray-600 text-center mb-6">We'd love to hear from you! Fill out the form below or reach out via email or WhatsApp.</p>
          ...
          <form className="space-y-4 w-full">
            <input type="text" placeholder="Your Name" className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:border-red-500 focus:ring-2 focus:ring-red-200 transition-all shadow-sm" />
            <input type="email" placeholder="Your Email" className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:border-red-500 focus:ring-2 focus:ring-red-200 transition-all shadow-sm" />
            <textarea placeholder="Your Message" className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:border-red-500 focus:ring-2 focus:ring-red-200 transition-all shadow-sm" rows={4}></textarea>
            <button type="submit" className="w-full bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-bold px-6 py-3 rounded-full shadow-lg transition-all text-lg">Send Message</button>
          </form>
        </div>
      </div>
      <Footer />
